...
var (
	...
	ErrDateTimePast                           error = errors.New("Date time can't be in the past")
	ErrRegisterDeadlinePast                   error = errors.New("RegisterDeadline can't be in the past")
	ErrDeregisterDeadlinePast                 error = errors.New("DeregisterDeadline can't be in the past")
	ErrRegisterDeadlineAfterDateTime          error = errors.New("RegisterDeadline can't be after Date time")
	ErrDeregisterDeadlineAfterDateTime        error = errors.New("DeregisterDeadline can't be after Date time")
	ErrRegisterDeadlineAfterDerigsterDeadline error = errors.New("RegisterDeadline can't be after DerigsterDeadline")
)
