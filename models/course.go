...
func (o *Course) Forum(mods ...qm.QueryMod) forumQuery {
	...
	query := Forums(queryMods...)
	queries.SetFrom(query.Query, "`forum`")
...
func (o *Course) Appointments(mods ...qm.QueryMod) appointmentQuery {
	...
	query := Appointments(queryMods...)
	queries.SetFrom(query.Query, "`appointment`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`appointment`.*"})
	}
...
func (o *Course) CourseHasFiles(mods ...qm.QueryMod) courseHasFileQuery {
	...
	query := CourseHasFiles(queryMods...)
	queries.SetFrom(query.Query, "`course_has_files`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`course_has_files`.*"})
	}
...
func (o *Course) Directories(mods ...qm.QueryMod) directoryQuery {
	...
	query := Directories(queryMods...)
	queries.SetFrom(query.Query, "`directory`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`directory`.*"})
	}
...
func (o *Course) FieldOfStudyHasCourses(mods ...qm.QueryMod) fieldOfStudyHasCourseQuery {
	...
	query := FieldOfStudyHasCourses(queryMods...)
	queries.SetFrom(query.Query, "`field_of_study_has_course`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`field_of_study_has_course`.*"})
	}
...
func (o *Course) Submissions(mods ...qm.QueryMod) submissionQuery {
	...
	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`submission`.*"})
	}
