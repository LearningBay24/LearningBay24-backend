...
func main() {
	...
	router.PATCH("/courses/:course_id/submissions/:id/grade", pCtrl.GradeUserSubmission)
	router.DELETE("courses/:course_id/submissions/:id", pCtrl.DeleteSubmission)
	router.PATCH("courses/:course_id/submissions/:id", pCtrl.EditSubmissionById)
	router.POST("/courses/:course_id/submissions/:id/files", pCtrl.CreateSubmissionHasFiles)
	router.DELETE("/courses/:course_id/submissions/:id/files/:file_id", pCtrl.DeleteSubmissionHasFiles)
	router.POST("/courses/:course_id/submissions/:id/usersubmissions", pCtrl.CreateUserSubmission)
	router.DELETE("/courses/:course_id/submissions/usersubmissions/:id", pCtrl.DeleteUserSubmission)
	router.POST("/courses/:course_id/submissions/usersubmissions/:id/files", pCtrl.CreateUserSubmissionHasFiles)
	router.DELETE("/courses/:course_id/submissions/usersubmissions/:id/files/:file_id", pCtrl.DeleteUserSubmissionHasFiles)
