...
func main() {
	...
	router.PATCH("/courses/submissions/usersubmissions/:usersubmission_id/grade", pCtrl.GradeUserSubmission)
	router.DELETE("courses/:id/submissions/:submission_id", pCtrl.DeleteSubmission)
	router.PATCH("courses/submissions/:submission_id", pCtrl.EditSubmissionById)
	router.GET("/courses/submissions/:submission_id/files", pCtrl.GetFileFromSubmission)
	router.POST("/courses/submissions/:submission_id/files", pCtrl.CreateSubmissionHasFiles)
	router.DELETE("/courses/submissions/:submission_id/files/:file_id", pCtrl.DeleteSubmissionHasFiles)
	router.POST("/courses/submissions/:submission_id/usersubmissions", pCtrl.CreateUserSubmission)
	router.DELETE("/courses/submissions/usersubmissions/:usersubmission_id", pCtrl.DeleteUserSubmission)
	...
	router.DELETE("/courses/submissions/usersubmissions/:usersubmission_id/files/:file_id", pCtrl.DeleteUserSubmissionHasFiles)
