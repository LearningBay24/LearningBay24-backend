...
func CreateCourse(db *sql.DB, name, enrollkey string, description null.String, usersid []int) {
...
func UpdateCourse(db *sql.DB, id int, name, enrollkey string, description null.String) {
...
func DeactivateCourse(db *sql.DB, id int) {
